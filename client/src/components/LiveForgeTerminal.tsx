...
const forgeSteps = [
  ...
  { text: "$ soulclaw forge --agent sentinel-alpha", color: "#00FFFF", delay: 70 },
  { text: "[AGENT] Agent ID: 0xA7f3...9cD2 | Status: ALIVE", color: "#4ade80", delay: 50 },
  { text: "[AGENT] Loading identity files...", color: "#facc15", delay: 50 },
  { text: "", color: "", delay: 300 },
  ...
  { text: "[STORE] Files stored permanently → id: sc_7xK2p...mN4q", color: "#facc15", delay: 60 },
  { text: "[STORE] Confirmed                                   ✓", color: "#4ade80", delay: 50 },
  { text: "", color: "", delay: 300 },
  { text: "$ calculating Soul Engine Score...", color: "#FF2D55", delay: 70 },
  { text: "[SCORE] Intelligence ████████████████░░░░ 240/300", color: "#00FFFF", delay: 50 },
  { text: "[SCORE] Strategy     ██████████████░░░░░░ 175/250", color: "#00FFFF", delay: 50 },
  { text: "[SCORE] Risk Profile ████████████████████ 250/250", color: "#00FFFF", delay: 50 },
  { text: "[SCORE] Trust        ██████████████░░░░░░ 140/200", color: "#00FFFF", delay: 50 },
  { text: "[SCORE] Total: 1805 / 5000                         ✓", color: "#4ade80", delay: 40 },
  { text: "", color: "", delay: 300 },
  { text: "$ broadcasting to SOUL TERMINAL...", color: "#FF2D55", delay: 70 },
  { text: "[SSE] Event pushed to 12 connected clients          ✓", color: "#4ade80", delay: 50 },
  { text: "[LIVE] soul@terminal:~$ forge complete", color: "#facc15", delay: 50 },
  { text: "", color: "", delay: 400 },
  { text: "═══════════════════════════════════════════════════════", color: "#FF2D55", delay: 20 },
  { text: "  >>> SOUL FORGED — IDENTITY STORED PERMANENTLY <<<", color: "#00FFFF", delay: 100 },
  { text: "═══════════════════════════════════════════════════════", color: "#FF2D55", delay: 20 },
    ...
    <section className="py-16 px-4" data-testid="section-live-forge">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-xs text-white/40 text-center mb-8 font-mono">
          Watch souls being forged and scored in real-time
        </p>
        ...
        <div className="relative rounded-xl overflow-hidden border border-[#FF2D55]/30 shadow-[0_0_30px_rgba(255,45,85,0.15),0_0_60px_rgba(0,255,255,0.05)]">
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 bg-[#0a0a0a] border-b border-[#1a1a1a]">
            ...
            <span className="text-[10px] font-mono text-white/30 ml-2">soul@terminal ~ /forge</span>
